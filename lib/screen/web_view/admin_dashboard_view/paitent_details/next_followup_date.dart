              ...
              itemBuilder: (context,index){
                ...
                return Container(
                  ...
                  child: ListTile(
                    ...
                    subtitle: CommonTextWidget(text: data['reason'],top: 0,fontSize: 12,),
                    trailing: CommonTextWidget(text: data['nextFollowUpDate'],fontWeight: FontWeight.w600,fontSize: 13,),
