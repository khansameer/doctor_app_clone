        ...
        return ListView.builder(
          ...
          return Container(
            ...
            child: ListTile(
                  ...
                  Container(
                    ...
                    child: Center(
                      child: Padding(
                        ...
                        child: CommonTextWidget(text: data.isActive==false?"InActive":"Active",textColor:  data.isActive==false?Colors.red:Colors.green,fontWeight: FontWeight.w400,),
                      ),
                    ),
                  ),
                  commonInkWell(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Padding(
                          ...
                          child: CommonTextWidget(text: "View Profile",fontWeight: FontWeight.w600,),
                        ),
                      ),
                    ),
                  ),
              ...
              title: CommonTextWidget(text: data.name.toString(),fontWeight: FontWeight.w700,fontSize: 14,),
              subtitle: CommonTextWidget(text: "28 years",top: 5,
              fontSize: 12,),
            ),
          );
        });
