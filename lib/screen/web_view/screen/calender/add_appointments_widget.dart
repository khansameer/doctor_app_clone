                        ...
                        Consumer<PatientProvider>(
                          ...
                          /*      if (context
                              ...
                              if (suggestion.item?.gender != null) {
                                final genderString = suggestion.item?.gender.toString().toLowerCase();

                                if (context.read<ProfileProvider>().itemGenderList
                                    .map((gender) => gender.toLowerCase())
                                    .contains(genderString)) {
                                  print('---------------------------asassas $genderString');
                                  providerApt.setGenderValue(genderString.toString().toCapitalize());
                                }
                              }
