...
class AdminWebReport extends StatelessWidget {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  _topView(size: size, provider: provider),
                  const SizedBox(
                    height: 20,
                  ),
                  Container(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child:
                            _commonSummaryView(title: "Tax", price: '\$0.00'),
                      ),
                      Expanded(
                        child: _commonSummaryView(
                            title: "Invoice Amount", price: "\$30,48,130.00"),
                      ),
                    ],
                  ),
                  const SizedBox(
  ...
  _topView({required Size size, required ReportProvider provider}) {
    return Row(
      children: [
        Expanded(
          flex: 6,
            ...
            children: [
              ...
              SizedBox(
                ...
                child: CommonDropDownView(
                    horizontal: 10,
                    hint: "Income",
                    borerColor: Colors.grey.withValues(alpha: 0.4),
