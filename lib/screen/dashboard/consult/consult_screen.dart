...
class ConsultScreen extends StatelessWidget {
  ...
  commonView({String? title,String? desc,bool isBthShow=false}) {
    return commonList(
        child: Padding(
          padding: const EdgeInsets.only(
              left: 15.0, right: 15, top: 10, bottom: 10),
          child: Column(
            ...
            children: [
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.end,
                children: [
                  isBthShow?SizedBox.shrink(): Align(
                    alignment: Alignment.topRight,
                    child: commonInkWell(
                        child: CommonTextWidget(
                          text: "GO TO SETTINGS",
                  ...
                  isBthShow?SizedBox.shrink(): const SizedBox(
                    width: 50,
                  ),
                  Align(
                    alignment: Alignment.topRight,
