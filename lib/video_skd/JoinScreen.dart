...
import 'api_call.dart';import 'package:http/http.dart' as http;
import 'package:http/http.dart' as http;
class JoinScreenSS extends StatelessWidget {
  final _meetingIdController = TextEditingController();

  JoinScreenSS({super.key});
  ...
  void onCreateButtonPressed(BuildContext context) async {
    ...
    await createMeeting().then((meetingId) {
      ...
      Navigator.of(context).push(
        MaterialPageRoute(
          builder: (context) => MeetingScreenSS(
            meetingId: meetingId,
            token: token,
          ),
        ),
